...
@Component({
  selector: 'app-zambia-classes',
  templateUrl: './zambia-classes.component.html',
  styleUrls: ['./zambia-classes.component.scss']
})
export class ZambiaClassesComponent implements OnInit {
