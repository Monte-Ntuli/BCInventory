...
@Component({
  selector: 'app-pretoria-classes',
  templateUrl: './pretoria-classes.component.html',
  styleUrls: ['./pretoria-classes.component.scss']
})
export class PretoriaClassesComponent implements OnInit {
